...
additional_tranformations=["/usr/local/easydb-migration/easydb-migration-tools/transformations/nutzer_gruppen_pools.json", "/usr/local/easydb-migration/easydb-migration-tools/transformations/collections.json"] # List additional transformation dictionary files here (dictionaries must be in JSON format)
